...
namespace YH.Framework.Caching.Telemetry;
...
public static class CachingTelemetry
{
    ...
    public const string ActivitySourceName = "YH.Caching";

    /// <summary>Name of the <see cref="Meter"/> used for cache metrics.</summary>
    public const string MeterName = "YH.Caching";
