...
/// <summary>
/// List links in a module. <see cref="ProjectId"/> and <see cref="ModuleId"/> are populated from the route.
/// </summary>
public sealed class ListModuleLinksQuery : IQuery<List<ModuleLinkDto>>
{
