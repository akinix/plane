...
/// <summary>
/// List issues in a cycle. <see cref="ProjectId"/> and <see cref="CycleId"/> are populated from the route.
/// </summary>
public sealed class ListCycleIssuesQuery : IQuery<List<IssueDto>>
{
