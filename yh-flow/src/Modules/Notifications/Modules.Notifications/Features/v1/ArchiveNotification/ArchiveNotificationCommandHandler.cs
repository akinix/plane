...
public sealed class ArchiveNotificationCommandHandler(
    NotificationsDbContext db,
    ICurrentUser currentUser)
    : ICommandHandler<ArchiveNotificationCommand, Unit>
{
    public async ValueTask<Unit> Handle(ArchiveNotificationCommand cmd, CancellationToken cancellationToken)
    {
