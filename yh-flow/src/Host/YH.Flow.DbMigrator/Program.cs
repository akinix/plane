...
if (string.IsNullOrWhiteSpace(builder.Configuration["JwtOptions:SigningKey"]))
{
    builder.Configuration.AddInMemoryCollection(new Dictionary<string, string?>
    {
        ...
        ["JwtOptions:Issuer"] = builder.Configuration["JwtOptions:Issuer"] ?? "YH.local",
        ["JwtOptions:Audience"] = builder.Configuration["JwtOptions:Audience"] ?? "YH.clients",
    });
}
...
builder.Services.AddSingleton<YH.Framework.Jobs.Services.IJobService, NoOpJobService>();
