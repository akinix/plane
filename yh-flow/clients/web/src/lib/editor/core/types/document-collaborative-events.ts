...
// FLOW: Forked from @plane/editor/src/core/types/document-collaborative-events.ts

import type { DocumentCollaborativeEvents } from "../../core/constants/document-collaborative-events";
