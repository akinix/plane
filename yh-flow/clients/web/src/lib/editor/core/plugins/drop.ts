...
// FLOW: Forked from @plane/editor/src/core/plugins/drop.ts

import type { Editor } from "@tiptap/core";
import { Plugin, PluginKey } from "@tiptap/pm/state";
// constants
import { ACCEPTED_ATTACHMENT_MIME_TYPES, ACCEPTED_IMAGE_MIME_TYPES } from "../../core/constants/config";
// types
import type { TEditorCommands, TExtensions } from "../../core/types";
