...
// FLOW: Forked from @plane/editor/src/core/extensions/table/table/utilities/create-table.ts

import type { Fragment, Node as ProsemirrorNode, Schema } from "@tiptap/pm/model";
// extensions
import { createCell } from "../../../../../core/extensions/table/table/utilities/create-cell";
import { getTableNodeTypes } from "../../../../../core/extensions/table/table/utilities/get-table-node-types";
