...
// FLOW: Forked from @plane/editor/src/core/extensions/side-menu.ts
...
// plugins
import { AIHandlePlugin } from "../../core/plugins/ai-handle";
import { DragHandlePlugin, nodeDOMAtCoords } from "../../core/plugins/drag-handle";
