...
// FLOW: Forked from @plane/editor/src/core/helpers/assets.ts

import type { Node as ProseMirrorNode } from "@tiptap/pm/model";
// plane imports
import type { ADDITIONAL_EXTENSIONS } from "../../../utils";
import { CORE_EXTENSIONS } from "../../../utils";
// extensions
import { getImageBlockId } from "../../core/extensions/custom-image/utils";
// plane editor imports
import { ADDITIONAL_ASSETS_META_DATA_RECORD } from "../../ce/constants/assets";
// types
import type { TEditorAsset } from "../../core/types";
