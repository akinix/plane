...
// FLOW: Forked from @plane/editor/src/core/helpers/editor-ref.ts
...
// components
import { getEditorMenuItems } from "../../core/components/menus";
// constants
import { CORE_EXTENSIONS } from "../../core/constants/extension";
import { CORE_EDITOR_META } from "../../core/constants/meta";
// types
import type { EditorRefApi, IEditorProps, TEditorCommands } from "../../core/types";
// local imports
...
export const getEditorRefHelpers = (args: TArgs): EditorRefApi => {
  ...
  return {
    ...
    getDocument: () => {
      const documentBinary = provider?.document ? null : null;
