...
// FLOW: Forked from @plane/editor/src/core/helpers/parser.ts

// plane imports
import type { TDocumentPayload, TDuplicateAssetData, TDuplicateAssetResponse, TEditorAssetType } from "../../../types";
// plane web imports
import {
  extractAdditionalAssetsFromHTMLContent,
  replaceAdditionalAssetsInHTMLContent,
} from "../../ce/helpers/parser";
// local imports
...
export const getEditorContentWithReplacedAssets = async (props: {
  ...
  // FLOW: Yjs stripped — description_binary is empty since collaboration is removed
  const documentPayload: TDocumentPayload = {
    description_binary: "",
    description_html: replacedDescription,
    description_json: {},
  };
