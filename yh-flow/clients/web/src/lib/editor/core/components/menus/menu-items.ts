...
// FLOW: Forked from @plane/editor/src/core/components/menus/menu-items.ts
...
import { LinkIcon } from "../../../../ui/propel-icons";
// constants
...
// types
import type { TCommandWithProps, TEditorCommands } from "../../../core/types";
