...
// FLOW: Forked from @plane/editor/src/core/components/editors/editor-container.tsx
...
// components
import type { TCollabValue } from "../../../core/contexts";
import { LinkContainer } from "../../../ce/components/link-container";
// plugins
import { nodeHighlightPluginKey } from "../../../core/plugins/highlight";
// types
import type { TDisplayConfig } from "../../../core/types";
...
type Props = {
  ...
  provider?: /* HocuspocusProvider removed */ any | undefined;
...
export function EditorContainer(props: Props) {
  ...
  return (
    <>
      ...
      >
        {children}
        {!isTouchDevice && <LinkContainer editor={editor} containerRef={containerRef as any} />}
      </div>
    </>
  );
}
