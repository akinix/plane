...
// FLOW: Forked from @plane/ui/src/breadcrumbs/breadcrumbs.tsx

import * as React from "react";
import { ChevronRightIcon } from "../propel-icons";
          ...
          <div className="flex items-center gap-2.5 p-1">
            {isLoading ? (
              ...
              React.cloneElement(childrenArray[childrenArray.length - 1] as React.ReactElement, {
                // @ts-expect-error FLOW: isLast is a custom BreadcrumbItem prop
                isLast: true,
              })
            ) : (
