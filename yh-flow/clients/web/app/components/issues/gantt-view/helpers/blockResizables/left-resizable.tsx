// FLOW: Forked from Plane gantt-chart/helpers/blockResizables/left-resizable.tsx
/**
...
export const LeftResizable = function LeftResizable(props: LeftResizableProps) {
  ...
  return (
    <>
      ...
      <div
        onMouseDown={(e) => { handleBlockDrag(e, "left"); }}
