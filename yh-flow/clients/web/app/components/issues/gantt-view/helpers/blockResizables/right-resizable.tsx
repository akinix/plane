// FLOW: Forked from Plane gantt-chart/helpers/blockResizables/right-resizable.tsx
/**
...
export const RightResizable = function RightResizable(props: RightResizableProps) {
