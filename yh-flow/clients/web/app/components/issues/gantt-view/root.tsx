// FLOW: Forked from Plane gantt-chart/root.tsx
// FLOW: Removed mobx-react observer wrapper
// FLOW: Simplified — direct issue rendering without MobX store
/**
...
export const GanttChartRoot = function GanttChartRoot(props: GanttChartRootProps) {
  const {
    border = true,
    title,
    blockIds,
