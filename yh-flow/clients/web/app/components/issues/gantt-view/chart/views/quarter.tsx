// FLOW: Forked from Plane gantt-chart/chart/views/quarter.tsx
// FLOW: Removed mobx-react observer wrapper, use plain function component
/**
...
export const QuarterChartView = function QuarterChartView(_props: any) {
